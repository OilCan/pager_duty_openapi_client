...
# Unit tests for PagerDutyOpenapiClient::Tag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe PagerDutyOpenapiClient::Tag do
  let(:instance) { PagerDutyOpenapiClient::Tag.new }

  describe 'test an instance of Tag' do
    it 'should create an instance of Tag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(PagerDutyOpenapiClient::Tag)
    end
  end
