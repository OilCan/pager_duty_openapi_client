...
# Unit tests for OpenapiClient::EventRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventRule do
  let(:instance) { OpenapiClient::EventRule.new }

  describe 'test an instance of EventRule' do
    it 'should create an instance of EventRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EventRule)
    end
  end
