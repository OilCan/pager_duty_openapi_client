...
# Unit tests for OpenapiClient::UpdateIncidentsRequestIncidentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateIncidentsRequestIncidentsInner do
  let(:instance) { OpenapiClient::UpdateIncidentsRequestIncidentsInner.new }
  ...
  describe 'test an instance of UpdateIncidentsRequestIncidentsInner' do
    it 'should create an instance of UpdateIncidentsRequestIncidentsInner' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::UpdateIncidentsRequestIncidentsInner)
    end
  end
