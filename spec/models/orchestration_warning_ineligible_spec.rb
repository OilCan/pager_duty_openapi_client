...
# Unit tests for OpenapiClient::OrchestrationWarningIneligible
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrchestrationWarningIneligible do
  let(:instance) { OpenapiClient::OrchestrationWarningIneligible.new }
  ...
  describe 'test an instance of OrchestrationWarningIneligible' do
    it 'should create an instance of OrchestrationWarningIneligible' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::OrchestrationWarningIneligible)
    end
  end
