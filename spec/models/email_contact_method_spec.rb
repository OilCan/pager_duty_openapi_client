...
# Unit tests for OpenapiClient::EmailContactMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmailContactMethod do
  let(:instance) { OpenapiClient::EmailContactMethod.new }

  describe 'test an instance of EmailContactMethod' do
    it 'should create an instance of EmailContactMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EmailContactMethod)
    end
  end
