  ...
  class EventRule
    ...
    def self.openapi_types
      {
        ...
        :'_self' => :'String',
        :'disabled' => :'Boolean',
        :'conditions' => :'EventRuleAllOfConditions',
        :'time_frame' => :'EventRuleAllOfTimeFrame',
        :'variables' => :'Array<EventRuleAllOfVariables>',
        :'position' => :'Integer',
        :'catch_all' => :'Boolean',
        :'actions' => :'EventRuleAllOfActions'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::EventRule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::EventRule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, _self, disabled, conditions, time_frame, variables, position, catch_all, actions].hash
    end
