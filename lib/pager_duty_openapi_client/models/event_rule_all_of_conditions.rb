...
module PagerDutyOpenapiClient
  ...
  class EventRuleAllOfConditions
    ...
    def self.openapi_types
      {
        :'operator' => :'String',
        :'subconditions' => :'Array<EventRuleAllOfConditionsSubconditions>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::EventRuleAllOfConditions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::EventRuleAllOfConditions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subconditions')
        if (value = attributes[:'subconditions']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @subconditions.nil?
        invalid_properties.push('invalid value for "subconditions", subconditions cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subconditions.nil?
      true
    end
