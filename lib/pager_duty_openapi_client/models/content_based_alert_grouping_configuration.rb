...
module PagerDutyOpenapiClient
  ...
  class ContentBasedAlertGroupingConfiguration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::ContentBasedAlertGroupingConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::ContentBasedAlertGroupingConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@time_window.nil? && @time_window > 86400
        invalid_properties.push('invalid value for "time_window", must be smaller than or equal to 86400.')
      end
    ...
    def valid?
      ...
      return false if !@time_window.nil? && @time_window > 86400
    ...
    def time_window=(time_window)
      ...
      if time_window > 86400
        fail ArgumentError, 'invalid value for "time_window", must be smaller than or equal to 86400.'
      end
