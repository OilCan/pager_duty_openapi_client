...
module PagerDutyOpenapiClient
  class ServiceOrchestrationAllOfOrchestrationPathAllOfCatchAllActions
    ...
    attr_accessor :pagerduty_automation_actions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::ServiceOrchestrationAllOfOrchestrationPathAllOfCatchAllActions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::ServiceOrchestrationAllOfOrchestrationPathAllOfCatchAllActions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pagerduty_automation_actions')
        if (value = attributes[:'pagerduty_automation_actions']).is_a?(Array)
          self.pagerduty_automation_actions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          suppress == o.suppress &&
          suspend == o.suspend &&
          pagerduty_automation_actions == o.pagerduty_automation_actions
    end
    ...
    def hash
      [suppress, suspend, pagerduty_automation_actions].hash
    end
