  ...
  class WebhookSubscription
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'active' => :'Boolean',
        :'delivery_method' => :'WebhookSubscriptionDeliveryMethod',
        :'description' => :'String',
        :'events' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::WebhookSubscription` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::WebhookSubscription`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'type')
        ...
        self.type = 'webhook_subscription'
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["webhook_subscription"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["webhook_subscription"])
    ...
    def hash
      [id, type, active, delivery_method, description, events, filter].hash
    end
