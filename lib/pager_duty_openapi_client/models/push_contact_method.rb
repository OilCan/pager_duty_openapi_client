  ...
  class PushContactMethod < ContactMethod
    ...
    def self.openapi_types
      {
        :'type' => :'String',
        :'device_type' => :'String',
        :'sounds' => :'Array<PushContactMethodSound>',
        :'created_at' => :'Time',
        :'blacklisted' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::PushContactMethod` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::PushContactMethod`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["push_notification_contact_method"])
      return false unless type_validator.valid?(@type)
      return false if @device_type.nil?
      device_type_validator = EnumAttributeValidator.new('String', ["android", "ios"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["push_notification_contact_method"])
    ...
    def hash
      [type, device_type, sounds, created_at, blacklisted].hash
    end
