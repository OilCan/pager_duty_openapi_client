...
module PagerDutyOpenapiClient
  class GetAnalyticsIncidentResponsesById200Response
    ...
    def self.openapi_types
      {
        ...
        :'order_by' => :'String',
        :'time_zone' => :'String',
        :'responses' => :'Array<AnalyticsRawIncidentResponses>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::GetAnalyticsIncidentResponsesById200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::GetAnalyticsIncidentResponsesById200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      order_by_validator = EnumAttributeValidator.new('String', ["requested_at"])
    ...
    def order_by=(order_by)
      validator = EnumAttributeValidator.new('String', ["requested_at"])
    ...
    def hash
      [incident_id, limit, order, order_by, time_zone, responses].hash
    end
