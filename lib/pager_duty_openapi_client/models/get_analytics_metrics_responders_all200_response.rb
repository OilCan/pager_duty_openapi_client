...
module PagerDutyOpenapiClient
  class GetAnalyticsMetricsRespondersAll200Response
    ...
    def self.openapi_types
      {
        :'filters' => :'AnalyticsResponderFilterFilters',
        :'time_zone' => :'String',
        :'order' => :'String',
        :'order_by' => :'String',
        :'data' => :'Array<AnalyticsResponderMetrics>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::GetAnalyticsMetricsRespondersAll200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::GetAnalyticsMetricsRespondersAll200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [filters, time_zone, order, order_by, data].hash
    end
