  ...
  class IncidentWorkflowAction
    ...
    def self.openapi_types
      {
        ...
        :'inputs' => :'Array<IncidentWorkflowActionAllOfInputs>',
        :'outputs' => :'Array<IncidentWorkflowActionAllOfOutputs>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PagerDutyOpenapiClient::IncidentWorkflowAction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PagerDutyOpenapiClient::IncidentWorkflowAction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["action"])
      return false unless type_validator.valid?(@type)
      action_type_validator = EnumAttributeValidator.new('String', ["action", "trigger"])
      return false unless action_type_validator.valid?(@action_type)
      trigger_type_validator = EnumAttributeValidator.new('String', ["polling", "subscription", "web"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["action"])
    ...
    def action_type=(action_type)
      validator = EnumAttributeValidator.new('String', ["action", "trigger"])
    ...
    def trigger_type=(trigger_type)
      validator = EnumAttributeValidator.new('String', ["polling", "subscription", "web"])
    ...
    def hash
      [type, domain_name, package_name, function_name, version, name, description, action_type, trigger_type, tags, search_keywords, metadata, created_at, created_by_user_id, inputs, outputs].hash
    end
